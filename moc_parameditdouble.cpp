...
void ParamEditDouble::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ParamEditDouble *_t = static_cast<ParamEditDouble *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ParamEditDouble::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ParamEditDouble.data,
      qt_meta_data_ParamEditDouble,  qt_static_metacall, nullptr, nullptr}
};
